...
-- This version enables the pg_cron extension first
...
-- TEST CRON JOB: Run at 12:40 today (give more time for setup)
SELECT cron.schedule(
    'weekly-credits-reset-test',
    '40 12 16 9 *',  -- At 12:40 on September 16th (today)
...
-- Test manually: SELECT public.reset_weekly_credits();